...
and use StoreKit 2 on iOS 15+ devices when available.
  ...
  s.source           = {
    :http => 'http://nexus.yonyow.com/repository/yonyowsdk-raw/YonyowSDKSwift/10.1.45/YonyowSDKSwift.xcframework.zip',
    :type => :zip,
    :sha256 => '005fece42b5459b9d4a169af4e3de2d28087083dadae77bd4e4e0c829bd01157'
  }
