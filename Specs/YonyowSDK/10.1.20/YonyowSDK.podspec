...
BREAKING CHANGE: All class prefixes changed from JLH to YYS.
  ...
  # 使用 Nexus HTTP 仓库
  s.source           = {
    :http => 'http://nexus.yonyow.com/repository/yonyowsdk-raw/YonyowSDK/10.1.20/YonyowSDK.xcframework.zip',
    :type => :zip,
    :sha256     => '617affe98be10706a27a6d81da3cb3b5b24fababfefffa5afebfac61d8943b7b'
  }
