...
BREAKING CHANGE: All class prefixes changed from JLH to YYS.
  ...
  # 使用 Nexus HTTP 仓库
  s.source           = {
    :http => 'http://nexus.yonyow.com/repository/yonyowsdk-raw/YonyowSDK/10.1.56/YonyowSDK.xcframework.zip',
    :type => :zip,
    :sha256     => '1f715cdd049e199c5ecf4fc052b3f22a2e7a8149b3100424292a86a81a34f975'
  }
