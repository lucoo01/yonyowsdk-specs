...
BREAKING CHANGE: All class prefixes changed from JLH to YYS.
  ...
  # 使用 Nexus HTTP 仓库
  s.source           = {
    :http => 'http://nexus.yonyow.com/repository/yonyowsdk-raw/YonyowSDK/10.1.51/YonyowSDK.xcframework.zip',
    :type => :zip,
    :sha256     => '26ea2a3f28605147e677b9227ef240d9dddcdf720fcac2d1742a7be1d278f7a0'
  }
  ...
  # 数据分析（GA4，与安卓端事件对齐；与 Messaging 共用同一 Firebase 11.x）
  s.dependency 'Firebase/Analytics', '~> 11.6'
